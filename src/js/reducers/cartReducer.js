...
export default function(state = initial, action) {
	...
	switch (action.type) {
		...
		case types.LOAD_CART_SUCCESS:
			...
			const totalAmountR = amountsR.reduce((total, currentValue) => total + currentValue);
		...
		case types.ADD_COUNTER:
			...
			const totalAmount = amounts.reduce((total, currentValue) => total + currentValue);
		...
		case types.LESS_COUNTER:
			...
			const totalAmountL = amountsL.reduce((total, currentValue) => total + currentValue);
